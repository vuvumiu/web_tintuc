...
<div class="col-md-12">
  <div class="card-header">
    ...
    <div class="card card-primary">
      ...
      <div class="form-group">
          <label for="exampleInputEmail1">Thẻ meta description </span></label>
          <textarea name="MetaDescription" rows="6" class="form-control"></textarea>
      </div> 
      
    <div class="form-group">
          <label for="exampleInputEmail1">Thẻ meta keyword </span></label>
      ...
      <div class="form-group">
          <label for="exampleInputEmail1">Giới thiệu ngắn </span></label>
      ...
      <div class="form-group">
          ...
          <textarea id="ckeditor" name="Description" rows="8" class="form-control"></textarea>
      </div>      
        </div> 
