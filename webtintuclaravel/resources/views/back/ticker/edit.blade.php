...
@section('title', 'Sửa Tin nóng')
@section('heading', 'Sửa Tin nóng')
...
<div class="col-md-12">
    <div class="card card-default">
        ...
        <form action="{{ url('admin/ticker/edit/' . $Ticker->RowID) }}" method="POST">
            @csrf
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <select name="news_id" id="news_id" class="form-control select2" data-placeholder="Chọn bài viết cho tin nóng">
                            ...
                            @foreach($News as $n)
                                <option value="{{ $n->RowID }}"
                                    {{ old('news_id', $Ticker->news_id) == $n->RowID ? 'selected' : '' }}>
                        ...
                        <small class="form-text text-muted">
                            ...
                            Bạn cũng có thể bỏ trống để nhập tiêu đề tùy chỉnh.
                        </small>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="title" id="title" value="{{ old('title', $Ticker->title) }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <select name="Status" class="form-control">
                            <option value="1" {{ old('Status', $Ticker->Status) == 1 ? 'selected' : '' }}>Bật</option>
                            <option value="0" {{ old('Status', $Ticker->Status) == '0' ? 'selected' : '' }}>Tắt</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="number" name="Sort" value="{{ old('Sort', $Ticker->Sort) }}"
